...
export const api = {
  ...
  excelGridGenerateImages: (form) => http.post("/excel/grid-generate-images", form, { timeout: 0 }),
  excelGridRegenCopy: (form) => http.post("/excel/grid-regen-copy", form, { timeout: 0 }),
  excelGridInferFields: (form) => http.post("/excel/grid-infer-fields", form, { timeout: 0 }),
